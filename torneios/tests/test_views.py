...
class ViewDetalharPartidaTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.partida = Partida.objects.filter(jogador_1__nome='Aceblind', jogador_2__nome='bløwer', round__indice=7)
    ...
    def test_acesso_deslogado(self):
        ...
        self.assertContains(response, reverse('torneios:detalhar_jogador_torneio', kwargs={'jogador_id': self.partida.jogador_1.id}), 1)
        self.assertContains(response, reverse('torneios:detalhar_jogador_torneio', kwargs={'jogador_id': self.partida.jogador_2.id}), 1)
